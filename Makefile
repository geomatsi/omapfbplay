...
$(if $(findstring y,$(OMAPFB) $(GLES-NWS) $(GLES2-X11) $(GLES-X11) $(GLUT) $(XV) $(V4L2)),,$(error No display drivers enabled))
...
LDLIBS-$(GLES2-X11)     += -lEGL -lGLESv2 -lX11
